                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-header pt-3 pb-3 text-center bg-primary">
                                                                <div class="text-center w-75 m-auto">
                                                                    <h3 style="font-size: 20px;" class="text-white text-center pb-0 fw-bold mb-0">CREATE TASK</h3>                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="card-body p-4">
                                                                ...
                                                                <form action="{{ route('user.submitTask') }}" method="POST" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <div class="mb-2">
                                                                    ...
                                                                    <div class="mb-2">
                                                                        ...
                                                                        <div class="input-group input-group-merge">
                                                                            <textarea class="form-control" name="description" rows="2" placeholder=""></textarea>
                                                                        </div>
                                                                    </div>
